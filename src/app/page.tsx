        ...
        <section className="relative pt-32 pb-20 px-4 overflow-hidden grid-pattern">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
              Detect Abandoned &amp; Vulnerable{' '}
              <span className="gradient-text">Dependencies Instantly</span>
            </h1>

            <p className="text-lg sm:text-xl text-surface-400 max-w-3xl mx-auto mb-10 leading-relaxed">
              Scan your{' '}
              <code className="text-primary-400 bg-primary-600/10 px-1.5 py-0.5 rounded text-base">package.json</code>,{' '}
              <code className="text-primary-400 bg-primary-600/10 px-1.5 py-0.5 rounded text-base">requirements.txt</code>,{' '}
              or any dependency file for CVE vulnerabilities, unmaintained packages, and supply chain risks.
              Get risk scores, bus factor analysis, and replacement suggestions — all running 100% in your browser.
            </p>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How to Scan Your Dependencies for{' '}
                <span className="gradient-text">Security Risks</span>
              </h2>
              ...
              {[
                {
                  step: '01',
                  icon: Upload,
                  title: 'Add Your Dependencies',
                  desc: 'Paste your package.json, upload a file, enter a GitHub repo URL, or connect your GitHub account to select any repository.',
                },
                {
                  step: '02',
                  icon: Search,
                  title: 'Automated CVE & Risk Analysis',
                  desc: 'We check each package against the OSV vulnerability database, registries for staleness, deprecation, bus factor, and 5 other risk signals.',
                },
                {
                  step: '03',
                  icon: BarChart3,
                  title: 'Actionable Risk Report',
                  desc: 'Get a prioritized dashboard with risk scores, CVE details with severity ratings, and curated replacement suggestions for every risky package.',
                },
              ].map((item) => (
                <div
                  key={item.step}
        ...
        <section id="features" className="py-24 px-4 bg-surface-900/30 border-y border-surface-800">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Most Complete{' '}
                <span className="gradient-text">Dependency Risk Scanner</span>
              </h2>
              <p className="text-surface-400 text-lg max-w-2xl mx-auto">
              ...
              {[
                {
                  ...
                  desc: 'Checks every dependency against Google\'s OSV database for known security vulnerabilities with CVSS severity ratings.',
                  color: 'text-red-500',
                },
                {
                  icon: AlertTriangle,
                  title: 'Deadware Risk Score',
                  desc: 'Every package gets a 0-100 risk score based on 7 weighted factors: staleness, bus factor, archived status, CVEs, deprecation, and more.',
                  color: 'text-red-400',
                },
                {
                  icon: GitBranch,
                  title: 'Bus Factor Analysis',
                  desc: 'Identify single-maintainer packages — the #1 predictor of future abandonment and supply chain incidents.',
                  color: 'text-amber-400',
                },
                {
                  icon: Package,
                  title: '5 Ecosystems Supported',
                  desc: 'npm (package.json), PyPI (requirements.txt), RubyGems (Gemfile), Go Modules (go.mod), and Cargo (Cargo.toml).',
                  color: 'text-blue-400',
                },
                {
                  icon: CheckCircle2,
                  title: '50+ Replacement Suggestions',
                  desc: 'Get curated, actively-maintained alternatives for every risky package — from "moment" to "date-fns".',
                  color: 'text-green-400',
                },
                {
                  icon: Eye,
                  title: 'Deprecation Detection',
                  desc: 'Instantly detect npm deprecated packages with the exact deprecation message from maintainers.',
                  color: 'text-orange-400',
                },
                {
                  icon: Download,
                  title: 'PDF, JSON & CSV Export',
                  desc: 'Export reports as PDF for stakeholders, JSON for CI/CD, or CSV for spreadsheets.',
                  color: 'text-purple-400',
                },
                {
                  icon: Lock,
                  title: 'Privacy-First (BYOK)',
                  desc: 'All analysis runs in your browser. Bring your own GitHub token for richer data. Nothing ever leaves your machine.',
                  color: 'text-teal-400',
                },
                {
                  icon: Github,
                  title: 'GitHub Integration',
                  desc: 'Scan any public repo by URL, or connect your account to browse and scan private repos.',
                ...
                },
                {
                  ...
                  desc: 'Sort by risk, name, or staleness. Filter by level. Find the most dangerous dependencies instantly.',
                  color: 'text-cyan-400',
                },
                {
                  icon: Zap,
                  title: 'Instant Results',
                  desc: 'Scans complete in seconds with parallel registry and CVE lookups. No queues or accounts needed.',
        ...
        <section className="py-24 px-4 bg-surface-900/30 border-t border-surface-800">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-surface-400 text-lg mb-8 max-w-xl mx-auto">
              Join developers who scan their dependencies for vulnerabilities, abandoned packages, and supply chain risks — for free, with zero setup.
            </p>
