          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-surface-900/50 border border-surface-800 rounded-2xl p-8 flex flex-col">
                ...
                <Link
                  href="/scanner"
                  className="w-full py-3 rounded-lg border border-surface-600 text-surface-200 text-center font-medium hover:bg-surface-800 transition-colors text-sm"
                >
                  Get Started Free
                </Link>
              </div>
              ...
              <div className="bg-surface-900/50 border-2 border-primary-500 rounded-2xl p-8 flex flex-col relative">
                ...
                <a
                  href="#"
                  data-stripe-link="pro"
                  className="w-full py-3 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-center font-medium transition-colors text-sm"
                >
                  Upgrade to Pro
                </a>
              </div>
